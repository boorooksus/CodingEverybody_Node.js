            ...
            var a_list = {
                ...
                showList:function(){
                    ...
                    for(key in a_list){
                        if(key !== "showList"){
                            if(key === "html"){
                                document.write("<li><a href=\""+a_list[key]+"\" style=font-weight:bold;>"+key+"</a></li>");
                            }
                            else{
...
//query string 값을 웹페이지의 제목으로 출력하는 코드
// template 웹페이지 출력할때 javaScript 문법은 잘 안됨. 사진 엑스박스. 이유는 모름